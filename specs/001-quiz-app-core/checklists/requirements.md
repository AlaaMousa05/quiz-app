...
- 2026-09-23 scope review: added User Story 5 (admin class/user management, FR-028–FR-031d) and full bilingual UI in scope (FR-033–FR-038), tightened import encoding to UTF-8/XLSX only with Windows-1256 deferred (FR-019a), clarified grace-period semantics (FR-008), and added negative-marking intro copy (FR-032). Checklist re-verified against the updated spec — still passing.
