...
| VIII. Every Assumption Is Written Down | Implementation-level decisions surfaced during planning (e.g., unpublish-before-first-attempt and class restore, both since resolved in favour of allowing them) are recorded in research.md/data-model.md with a rationale and in DECISIONS.md. |
